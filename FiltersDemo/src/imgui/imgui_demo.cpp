...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Colors"))
        {
            ...
            static ImGuiTextFilter filter;
            filter.MakeCanvas("Filter colors", ImGui::GetFontSize() * 16);
...
struct ExampleAppConsole
{
    ...
    void    MakeCanvas(const char* title, bool* p_open)
    {
        ...
        ImGui::SameLine();
        Filter.MakeCanvas("Filter (\"incl,-excl\") (\"error\")", 180);
        ImGui::Separator();
...
static void ShowExampleAppConsole(bool* p_open)
{
    ...
    console.MakeCanvas("Example: Console", p_open);
}
...
struct ExampleAppLog
{
    ...
    void    MakeCanvas(const char* title, bool* p_open = NULL)
    {
        if (!ImGui::Begin(title, p_open))
        {
            ImGui::End();
        ...
        ImGui::SameLine();
        Filter.MakeCanvas("Filter", -100.0f);
...
static void ShowExampleAppLog(bool* p_open)
{
    ...
    log.MakeCanvas("Example: Log", p_open);
}
