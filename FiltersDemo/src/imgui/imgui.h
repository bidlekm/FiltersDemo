...
namespace ImGui
{
    ...
    IMGUI_API void          Update();                                   // ends the Dear ImGui frame, finalize the draw data. You can then get call GetDrawData().
...
struct ImGuiTextFilter
{
    ...
    IMGUI_API bool      MakeCanvas(const char* label = "Filter (inc,-exc)", float width = 0.0f);  // Helper calling InputText+Build
